...
dir = '/work/ROMO/users/kpc/rfmeval/ap3/input/2030rg_ctl_v5_07e/';
...
Area_Emissions = csvread([dir 'AP2_emissions_2030rg_ctl_v5_07e_Area_fixed.csv'],0,1);
Low_Emissions = csvread([dir 'AP2_emissions_2030rg_ctl_v5_07e_LowStack_fixed.csv'],0,1);
...
%*****Update emissions file names here*****
Med_Emissions = csvread([dir 'AP2_emissions_2030rg_ctl_v5_07e_MedStackplusTS.fixed.csv'],0,1);
Tall_Emissions = csvread([dir 'AP2_emissions_2030rg_ctl_v5_07e_TallStack_fixed.csv'],0,1);
NewTall_Emissions = csvread([dir 'AP2_emissions_2030rg_ctl_v5_07e_NewTallStack_fixed.csv'],0,1);
