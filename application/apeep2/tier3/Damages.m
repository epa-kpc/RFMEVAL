% MORTALITY
 ...
 save('AP2_BPT_Estimates.mat', 'Mort_D_A','Mort_D_L','Mort_D_M','Mort_D_T','Mort_D_T2')
% xlswrite('AP3 BPT Estimates.xlsx',Mort_D_A,1,'A1')
% xlswrite('AP3 BPT Estimates.xlsx',Mort_D_L,2,'A1')
% xlswrite('AP3 BPT Estimates.xlsx',Mort_D_M,3,'A1')
% xlswrite('AP3 BPT Estimates.xlsx',Mort_D_T,4,'A1')
% xlswrite('AP3 BPT Estimates.xlsx',Mort_D_T2,5,'A1')

 csvwrite('AP2_BPT_Estimates_area.csv',Mort_D_A);
 csvwrite('AP2_BPT_Estimates_lowp.csv',Mort_D_L);
 csvwrite('AP2_BPT_Estimates_medium.csv',Mort_D_M);
 csvwrite('AP2_BPT_Estimates_tall.csv',Mort_D_T);
 csvwrite('AP2_BPT_Estimates_newtall.csv',Mort_D_T2);
