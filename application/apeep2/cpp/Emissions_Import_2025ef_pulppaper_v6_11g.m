...
dir = '/work/ROMO/users/kpc/rfmeval/ap3/input/2025ef_pulppaper_v6_11g/';

%%Area and Low Stack Sources
%Load AP3 .mat file for area and low stack sources
load '/work/ROMO/users/kpc/rfmeval/ap2/code.cpp/2011_PM_Worksheet_Area_Low_Western_Adj.mat'

%*****Update emissions file names here*****
Area_Emissions = csvread([dir 'AP2_emissions_2025ef_pulppaper_v6_11g_Area_fixed.csv'],0,1);
Low_Emissions = csvread([dir 'AP2_emissions_2025ef_pulppaper_v6_11g_LowStack_fixed.csv'],0,1);
...
clear dir check
save '/work/ROMO/users/kpc/rfmeval/ap2/code.cpp/2011_PM_Worksheet_Area_Low_Western_Adj.mat'
clear
...
load '/work/ROMO/users/kpc/rfmeval/ap2/code.cpp/2011_PM_Worksheet_Med_Tall_Western_Adj.mat'

%*****Update emissions file names here*****
Med_Emissions = csvread([dir 'AP2_emissions_2025ef_pulppaper_v6_11g_MedStackplusTS.fixed.csv'],0,1);
Tall_Emissions = csvread([dir 'AP2_emissions_2025ef_pulppaper_v6_11g_TallStack_fixed.csv'],0,1);
NewTall_Emissions = csvread([dir 'AP2_emissions_2025ef_pulppaper_v6_11g_NewTallStack_fixed.csv'],0,1);
...
save '/work/ROMO/users/kpc/rfmeval/ap2/code.cpp/2011_PM_Worksheet_Med_Tall_Western_Adj.mat'
clear
