...
dir = '/work/ROMO/users/kpc/rfmeval/ap3/input/2025ef_v6_11g/';
...
Area_Emissions = csvread([dir 'AP2_emissions_2025ef_v6_11g_Area_fixed.csv'],0,1);
Low_Emissions = csvread([dir 'AP2_emissions_2025ef_v6_11g_LowStack_fixed.csv'],0,1);
...
%*****Update emissions file names here*****
Med_Emissions = csvread([dir 'AP2_emissions_2025ef_v6_11g_MedStackplusTS.fixed.csv'],0,1);
Tall_Emissions = csvread([dir 'AP2_emissions_2025ef_v6_11g_TallStack_fixed.csv'],0,1);
NewTall_Emissions = csvread([dir 'AP2_emissions_2025ef_v6_11g_NewTallStack_fixed.csv'],0,1);
